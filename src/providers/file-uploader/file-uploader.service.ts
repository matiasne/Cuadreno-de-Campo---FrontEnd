...
import { HttpClient, HttpHandler, HttpErrorResponse, HttpHeaders, HttpRequest, HttpResponse } from '@angular/common/http';
...
export class FileUploaderService {
  ...
  constructor(private http: HttpClient) {
    ...
    this.url = GLOBAL.url + '/autos.php/subirFotos';	
  }
  ...
  private _upload(queueObj: FileQueueObject) {
    ...
    form.append("idAuto", this.idAuto.toString());
    form.append("isPreview", queueObj.isPreview.toString());
    form.append('fileToUpload', queueObj.file, queueObj.file.name);
